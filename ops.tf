module "ops" {
  ...
  bastion9_windows_ip                                  = "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.0.21"
  bastion10_windows_ip                                 = "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.0.22"
  bastion11_windows_ip                                 = "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.0.23"
  bastion12_windows_ip                                 = "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.0.24"
