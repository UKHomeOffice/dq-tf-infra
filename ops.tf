module "ops" {
  ...
  bastion_windows_2016_ip                      = "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.0.16"
  ...
  tableau_deployment_ip                        = ["${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.11", "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.12", "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.13", "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.14", "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.15", "${var.NAMESPACE == "prod" ? "10.2" : "10.8"}.6.16"]
